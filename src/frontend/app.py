...
from pages import page_caption, page_t2i, page_i2i
...
connect_mode = st.sidebar.checkbox(
    "🔗 페이지 연결 모드", value=True,
    help="ON: 페이지1에서 생성된 문구를 자동으로 페이지2/3에 사용"
)
...
if menu == "📝 홍보 문구+해시태그 생성":
    page_caption.render(connect_mode)
elif menu == "🖼 인스타그램 이미지 생성":
    page_t2i.render(connect_mode)
elif menu == "🖼️ 이미지 편집/합성":
    page_i2i.render(connect_mode)
...
# # C:\Users\devuser\Codeit\Ad_Content_Creation_Service_Team3\src\frontend\app.py
# # ============================================================
