...
INPUT_TEXT = "건강한 삶"
# 스타일 프롬프트 (수정하며 실험하세요)
PROMPT = "3d typography, made of liquid blue water, splashing dynamic, hyper realistic, 8k, unreal engine render, volumetric lighting"
NEGATIVE_PROMPT = "text, watermark, low quality, blurry, ugly, messy, distorted letters, jpeg artifacts"
FONT_URL = "https://fonts.gstatic.com/s/nanumbrushscript/v17/zjw4SUbdxXmI2W_lWdojGyO7O3j8.ttf"
FONT_PATH = "font.ttf"
OUTPUT_DIR = "./outputs"
...
def create_base_image(text, font_size=400): # size 인자 제거됨
...
def main():
    ...
    print("🚀 모델 로딩 시작... (L4 GPU의 힘을 믿으십시오)")
