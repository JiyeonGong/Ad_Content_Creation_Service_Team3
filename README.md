...
본 프로젝트는 Google Cloud Platform (GCP)의 GPU 인스턴스를 활용하여 구축되었습니다.
Flux.1과 같은 고성능 생성 모델의 원활한 추론을 위해 **24GB VRAM** 확보에 중점을 두었으며, 비용 효율성을 고려하여 AI 추론에 최적화된 **L4 GPU**를 선정했습니다.
